    ...
    IEquatable<Guid>
{
    ...
    private static void FillBytes7(byte[] bytes, ref long lastMillisecond, ref long millisecondCounter, ref uint monotonicCounter)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    private static void GetRandomBytes(byte[] bytes, int offset, int count)
    {
